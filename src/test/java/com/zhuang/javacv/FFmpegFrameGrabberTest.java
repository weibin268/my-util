...
public class FFmpegFrameGrabberTest {
    ...
    @Test
    public void test() throws FFmpegFrameGrabber.Exception, FFmpegFrameRecorder.Exception, InterruptedException {
        String filePath = "/Volumes/HD2/Temp/test.mp4";
        FFmpegFrameGrabber grabber = new FFmpegFrameGrabber("rtsp://120.236.148.68:554/openUrl/uUoLBss");
